...
public class Product {
    ...
    int price;
    @ManyToOne
    AppUser user;  //relation betweent user and product table
    //user in product table is sellers
    String rating;
    String description;
    ...
    public Product(UUID id, String name, String category, int quantity, int price, AppUser user, String rating, String description) {
        ...
        //one with values constructors
    }

    public Product() { //one empty constructors
    }
